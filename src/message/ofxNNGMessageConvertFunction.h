...
//#include "nlohmann/json.hpp"
//#else
//#define NEEDINDEX_SEQUENCE 1
//#endif
//#endif
//#ifdef NEEDINDEX_SEQUENCE
...
//		struct index_sequence : public integer_sequence<size_t, Ints...> {};
//
...
//			struct Gen
//			{
//				typedef typename Extend<typename Gen<T, N / 2>::type, N / 2, N % 2>::type type;
//			};
//
//			template <typename T>
//			struct Gen<T, 0>
...
//		{
//			typedef typename utility_internal::Gen<T, N>::type type;
//		};
//
//		template <size_t N>
//		struct make_index_sequence : public make_integer_sequence<size_t, N> {};
//
//		template <typename... Ts>
//		struct index_sequence_for : public make_index_sequence<sizeof...(Ts)> {};
//	}
//}
//#endif
